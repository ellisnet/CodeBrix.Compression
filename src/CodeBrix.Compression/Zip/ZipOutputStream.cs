...
public class ZipOutputStream : DeflaterOutputStream
{
    ...
    {
        var commentBytes = _stringCodec.ZipArchiveCommentEncoding.GetBytes(comment);
    ...
    /// </exception>
    /// <see cref="CodeBrix.Compression.Zip.Compression.Deflater"/>
    ...
    private void InitializeZipCryptoPassword(string password)
    {
        ...
        var key = PkzipClassic.GenerateKeys(ZipCryptoEncoding.GetBytes(password));
