...
public static class Utils
{
    ...
    private static Random random = new(DefaultSeed);
...
public class TempDir : FileSystemInfo, IDisposable
{
    ...
    public TempFile GetFile(string fileName) => new(FullPath, fileName);
